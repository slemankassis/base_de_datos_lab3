...
<body> 
<form action="AHP2C3.php" method="POST"> 

Seleccione un numero id: <select type="text" name="id_cliente"> 
            <?php  
              $cod_ve = array(); 
              $cod_vn = array(); 
             // $c = 0; 
              $consulta= "SELECT id_usuario FROM CLIENTE"; 
                 $resultado = mysql_query($consulta) or die('La consulta fall&oacute;: ' . mysql_error()); 
               
              while($linea = mysql_fetch_array($resultado)){ 
          
               
               echo " <option id_cliente=\"".$linea[0]."\">".$linea[0]."</option>\n"; 
