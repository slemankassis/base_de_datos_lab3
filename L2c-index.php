...
<body> 
<form action="L2c.php" method="POST"> 


Averiguar el nombre, la calle y la ciudad de residencia de todos los empleados que trabajan para la empresa:
 <select type="text" name="empresa"> 
	...
	<br> y ganan más de pesos anuales.: <input type="text" name="pesosanuales">
